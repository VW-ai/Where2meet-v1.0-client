...
import { UsersData, EmailIdentity, PasswordResetTokensData } from '@/types/user';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (identity) {
      ...
      const resetToken = authPersistence.generateSessionToken(); // Reuse session token generator
